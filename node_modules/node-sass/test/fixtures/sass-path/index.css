...
Error: File to import not found or unreadable: colors.
       Load path: C:/Projects/Weather-App-Using-Ajax-master/node_modules/node-sass/test/fixtures/sass-path
...
body:before {
  ...
  content: "Error: File to import not found or unreadable: colors.\A        Load path: C:/Projects/Weather-App-Using-Ajax-master/node_modules/node-sass/test/fixtures/sass-path\A         on line 1 of C:\Projects\Weather-App-Using-Ajax-master\node_modules\node-sass\test\fixtures\sass-path\index.scss\A \A 1: @import 'colors';\A 2: \A 3: body {\A 4:   background: $color;\A 5: }"; }
